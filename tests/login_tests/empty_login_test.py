...
class Empty_login_test(unittest.TestCase):
    ...
    def test_empty_login(self):
        ...
        #Get username field and add empty username
        empty_username = driver.find_element(By.ID,'user-name')
        ...
        self.assertIn("Epic sadface: Username is required",error_msg.text)
